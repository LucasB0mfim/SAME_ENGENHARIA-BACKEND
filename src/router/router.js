...
// Rotas de acesso
router.post('/login', validarAcesso(loginSchema), LoginController.autenticarColaborador);
router.post('/validar-token', autenticarToken, LoginController.token);
router.put('/atualizar-colaborador', autenticarToken, validarAcesso(atualizarSchema), CadastroController.cadastrarColaborador);
